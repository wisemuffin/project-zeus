# Data Source Ingestion Reference

How each source is ingested, how often it publishes new data, and how we automate refresh.
...
| UAC Field of Study × Gender | UAC | Excel file download | Annual (~Sep/Oct) | `0 9 1 11 *` | NSW/ACT |
| UAC Field of Study × App Type | UAC | Excel file download | Annual (~Sep/Oct) | `0 9 1 11 *` | NSW/ACT |
