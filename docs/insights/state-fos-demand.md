# State × Field of Study Demand

> Which fields are strongest in which states? Where should geo-targeted campaigns focus?

**Source models:** `state_fos_demand`, `stg_job_vacancies_by_state_fos`
**Data sources:** IVI job vacancies by occupation and state, occupation-FOS mapping, ABS youth population
