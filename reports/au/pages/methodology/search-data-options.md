---
title: Search Data Options
---

Comparison of available providers for search/trend data relevant to understanding prospective student interest. The pipeline currently uses **trendspyg** (free RSS feed) for real-time trending topic discovery. This page evaluates alternatives for when keyword-level interest-over-time data becomes important.
...
- **Cons**: Archived/unmaintained, relies on scraping Google Trends web UI, frequently breaks
...
- **trendspyg** — Open-source Python library for Google Trends RSS feed. Currently used in the pipeline.
- **Glimpse** — Commercial Google Trends overlay (meetglimpse.com). Pricing from public website.
- **Exploding Topics** — Commercial trend discovery platform (explodingtopics.com). Pricing from public website.
- **pytrends** — Archived/unmaintained unofficial Google Trends library. Not recommended.
- **Google Trends API** — Official API in alpha/limited access.
- Provider comparison based on publicly available information as of February 2026.
